...
public class GuiMenuPresenter {
     ...
     */
    public String getText(int menuIndex, int lineIndex) {
        try{
    ...
    public String getText(int menuIndex, int lineIndex, Object variable){
        try{
    ...
    public String getText(int menuIndex, int lineIndex, Object variable1, Object variable2){
        try{
